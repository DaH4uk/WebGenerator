...
public class OrderField implements IsWidget {
    ...
    public Widget asWidget() {
        if (generationContainer == null) {
                    ...
                    if (WebGenerator.tabPanel.getActiveWidget() == WebGenerator.internetTabPanel) {
                        ...
                        if (WebGenerator.phoneTabPanel.getActiveWidget() == WebGenerator.phoneNoSession) {
                            ...
                            if (NoIncomingOutgoingTab.samplesIncomingArea.getValue().equals("") && NoIncomingOutgoingTab.samplesOutgoingArea.getValue().equals("")) {
                                AlertMessageBox messageBox = new AlertMessageBox("Внимание!", "Не забудьте примеры номеров!");
                                messageBox.show();
            ...
            createBottomChecksContainer.add(createButton, new HorizontalLayoutContainer.HorizontalLayoutData(0.325, 0, new Margins(30, 0, 0, 0)));
            ...
            generationContainer.add(orderTextArea, new VerticalLayoutData(1, 0.6, new Margins(80, marginLeft, 0, marginLeft)));
            ...
            buttonsContainer.add(copyButton, new HorizontalLayoutContainer.HorizontalLayoutData(0.7, 0, new Margins(10, 0, 0, 210)));
